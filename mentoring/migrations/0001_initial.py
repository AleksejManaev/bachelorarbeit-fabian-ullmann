    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completed', models.CharField(default=b'-', max_length=100, verbose_name='Completed', choices=[(b'-', b'-'), (b'Completed', 'Completed'), (b'Failed', 'Failed')])),
            ],
        ),
        migrations.CreateModel(
            name='Address',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=10, verbose_name='Seminar type', choices=[(b'placement', b'placement'), (b'bachelor', b'bachelor'), (b'master', b'master')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(default=b'Not requested', max_length=100, verbose_name='State', choices=[(b'Not requested', 'Not requested'), (b'Requested', 'Requested'), (b'Mentoring denied', 'Mentoring denied'), (b'Mentoring accepted', 'Mentoring accepted'), (b'Seminar completed', 'Seminar completed'), (b'Report accepted', 'Report accepted'), (b'Certificate accepted', 'Certificate accepted'), (b'Placement completed', 'Placement completed'), (b'Placement failed', 'Placement failed'), (b'Archived', 'Archived')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expose', models.FileField(blank=True, upload_to=mentoring.helpers.upload_to_thesis_expose, null=True, verbose_name='Expose', validators=[mentoring.validators.validate_pdf, mentoring.validators.validate_size])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bachelor_year', models.IntegerField(null=True, verbose_name='Bachelor year', blank=True)),
                ('master_year', models.IntegerField(null=True, verbose_name='Master year', blank=True)),
