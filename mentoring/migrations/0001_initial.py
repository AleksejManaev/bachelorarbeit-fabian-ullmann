    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.FileField(blank=True, upload_to=mentoring.helpers.upload_to_report, null=True, verbose_name='report', validators=[mentoring.validators.validate_pdf, mentoring.validators.validate_size])),
                ('presentation', models.FileField(blank=True, upload_to=mentoring.helpers.upload_to_presentation, null=True, verbose_name='presentation', validators=[mentoring.validators.validate_pdf, mentoring.validators.validate_size])),
                ('certificate', models.FileField(blank=True, upload_to=mentoring.helpers.upload_to_certificate, null=True, verbose_name='certificate', validators=[mentoring.validators.validate_pdf, mentoring.validators.validate_size])),
