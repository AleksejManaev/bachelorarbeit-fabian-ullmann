...
urlpatterns = [
    ...
    url(r'^student/thesis/document/(?P<pk>\d+)/$', login_required(generate_thesis_document_student), name='student-thesis-document'),
    ...
    url(r'^tutor/thesis/document/(?P<pk>\d+)/$', login_required(generate_thesis_document_tutor), name='tutor-thesis-document'),
