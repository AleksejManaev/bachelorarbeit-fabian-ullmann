...
urlpatterns = [
    ...
    url(r'^placement/update/$', StudentPlacementFormView.as_view(),
    ...
    url(r'^placement/preview/$', StudentPlacementIndexView.as_view(), name='placement-preview'),

    url(r'^thesis/mentoring-request/update/$',
        StudentThesisMentoringrequestFormView.as_view(),
    ...
    url(r'^thesis/mentoring-request/preview/$', StudentThesisMentoringrequestView.as_view(),
        name='thesis-mentoringrequest-preview'),

    url(r'^thesis/registration/update/$',
        StudentThesisRegistrationFormView.as_view(),
