...
urlpatterns = [
    ...
    url(r'^thesis/mentoring-request/update/$',
        ThesisMentoringrequestUpdateView.as_view(template_name='mentoringrequest_form.html'),
        name='thesis-mentoringrequest-update'),
    url(r'^thesis/mentoring-request/update/todo/$',
        ThesisMentoringrequestUpdateView.as_view(template_name='mentoringrequest_todo_form.html'),
        name='thesis-mentoringrequest-update-todo'),

    url(r'^thesis/registration/update/$',
        ThesisRegistrationUpdateView.as_view(template_name='registration_form.html'),
        name='thesis-registration-update'),
    url(r'^thesis/registration/update/todo/$',
        ThesisRegistrationUpdateView.as_view(template_name='registration_todo_form.html'),
